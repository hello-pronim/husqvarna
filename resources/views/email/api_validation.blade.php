											...
											<table id="app-brand" cellpadding="0" cellspacing="0" border="0">
												<tbody>
													<tr>
														<td>
															<a href="{{route('home')}}">
										                        <img src="{{ asset('images/admin_logo.png') }}" srcset="{{ asset('images/admin_logo@2x.png') }} 2x, {{ asset('images/admin_logo@3x.png') }} 3x, {{ asset('images/admin_logo@4x.png') }} 4x" alt="logo" class="logo-default"/>
									                    	</a>
									                    </td>
									                </tr>
									            </tbody>
